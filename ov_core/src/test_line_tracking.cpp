...
int main(int argc, char **argv) {
  ...
  // Histogram method
  ov_core::LineTrackBase::Line_HistogramMethod method;
  ...
  if (histogram_method_str == "NONE") {
    method = ov_core::LineTrackBase::NONE;
  } else if (histogram_method_str == "HISTOGRAM") {
    method = ov_core::LineTrackBase::HISTOGRAM;
  } else {
  ...
  extractor = new TrackLineDescriptor(cameras, numlines, num_aruco, !use_stereo, method);
  //===================================================================================
  //===================================================================================
  //===================================================================================
...
void handle_stereo(double time0, double time1, cv::Mat img0, cv::Mat img1) {
  ...
  extractor->display_active(img_active, 255, 0, 0);
  ...
  // Get lost tracks
  std::shared_ptr<LineDatabase> linedatabase = extractor->get_line_database();

...
/*
  ...
  myfile3.open("/home/zhangyanyu/catkin_ws_ov/src/open_vins/sim_feat_est.txt", std::ofstream::app);
  myfile3 << "[Estimation] feature ID: " << (int(feat->featid)-4096) << " -> (" <<feat->p_FinG(0)<<" "<<feat->p_FinG(1)<<" "<<feat->p_FinG(2)<<")\n";
  myfile3.close();
*/
  return true;
}

...
#ifndef OV_CORE_LINE_TRACK_SIM_H
#define OV_CORE_LINE_TRACK_SIM_H
 ...
 */
class LineTrackSIM : public LineTrackBase {
...
public:
   ...
   */
  LineTrackSIM(std::unordered_map<size_t, std::shared_ptr<CamBase>> cameras, int numaruco)
      : LineTrackBase(cameras, 0, numaruco, false, Line_HistogramMethod::NONE) {}
...
#endif /* OV_CORE_LINE_TRACK_SIM_H */

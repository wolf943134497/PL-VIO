...
list(APPEND LIBRARY_SOURCES
        ...
        src/track/LineTrackSIM.cpp
	src/track/LineTrackBase.cpp
	src/track/TrackLineDescriptor.cpp

        src/types/Landmark.cpp
	src/types/Line_Landmark.cpp
        src/feat/Feature.cpp
        src/feat/FeatureInitializer.cpp
        src/feat/Line.cpp
        src/feat/LineInitializer.cpp
        src/utils/print.cpp
...
if (catkin_FOUND AND ENABLE_ROS)
    ...
    add_executable(test_line_tracking src/test_line_tracking.cpp)
    target_link_libraries(test_line_tracking ov_core_lib ${thirdparty_libraries})
    install(TARGETS test_line_tracking
            ARCHIVE DESTINATION ${CATKIN_PACKAGE_LIB_DESTINATION}
            LIBRARY DESTINATION ${CATKIN_PACKAGE_LIB_DESTINATION}
            RUNTIME DESTINATION ${CATKIN_PACKAGE_BIN_DESTINATION}
    )

    add_executable(test_point_line_tracking src/test_point_line_tracking.cpp)
    target_link_libraries(test_point_line_tracking ov_core_lib ${thirdparty_libraries})
    install(TARGETS test_point_line_tracking
            ARCHIVE DESTINATION ${CATKIN_PACKAGE_LIB_DESTINATION}
            LIBRARY DESTINATION ${CATKIN_PACKAGE_LIB_DESTINATION}
            RUNTIME DESTINATION ${CATKIN_PACKAGE_BIN_DESTINATION}
    )

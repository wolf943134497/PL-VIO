...
#include "feat/Line.h"
#include "feat/LineInitializer.h"
#include "feat/LineInitializerOptions.h"
...
public:
   ...
   */
  UpdaterMSCKF(UpdaterOptions &options, ov_core::FeatureInitializerOptions &feat_init_options, ov_core::LineInitializerOptions &line_init_options, bool &use_line) : _options(options), _use_line(use_line) {

    bool _use_line = use_line;
    ...
    initializer_line = std::unique_ptr<ov_core::LineInitializer>(new ov_core::LineInitializer(line_init_options));
   ...
   */
  void update(std::shared_ptr<State> state, std::vector<std::shared_ptr<ov_core::Feature>> &feature_vec, std::vector<std::shared_ptr<ov_core::Line>> &line_vec);
...
protected:
  ...
  std::unique_ptr<ov_core::LineInitializer> initializer_line;

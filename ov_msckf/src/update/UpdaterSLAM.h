...
public:
   ...
   */
  UpdaterSLAM(UpdaterOptions &options_slam, UpdaterOptions &options_aruco, ov_core::FeatureInitializerOptions &feat_init_options): _options_slam(options_slam), _options_aruco(options_aruco) {
...
protected:
  ...
  // void perform_line_anchor_change(std::shared_ptr<State> state, std::shared_ptr<ov_type::Line_Landmark> line_landmark, double new_anchor_timestamp, size_t new_cam_id);

...
struct VioManagerOptions {
  ...
  ov_core::LineTrackBase::Line_HistogramMethod line_histogram_method = ov_core::LineTrackBase::Line_HistogramMethod::HISTOGRAM;
  ...
  ov_core::LineInitializerOptions lineinit_options;
  ...
  void print_and_load_trackers(const std::shared_ptr<ov_core::YamlParser> &parser = nullptr) {
    if (parser != nullptr) {
      parser->parse_config("use_line", use_line);
      ...
      parser->parse_config("num_lines", num_lines);

...
public:
  ...
  cv::Mat get_historical_viz_image() {
    ...
    trackLINES->display_history(img_history, 255, 255, 0, 255, 255, 255, overlay);
    if (trackARUCO != nullptr) {
  ...
  std::vector<Eigen::Vector4d> get_good_lines_MSCKF() { return good_lines_MSCKF; }
...
protected:
  ...
  std::shared_ptr<ov_core::LineDatabase> trackLineDATABASE;

  /// Our sparse feature tracker (klt or descriptor)
  std::shared_ptr<ov_core::TrackBase> trackFEATS;
  
  std::shared_ptr<ov_core::LineTrackBase> trackLINES;
  ...
  std::vector<Eigen::Vector4d> good_lines_MSCKF;
  ...
  std::shared_ptr<ov_core::LineInitializer> active_line_tracks_initializer;
